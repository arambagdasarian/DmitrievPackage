...
class EnhancedNetworkAnalyzer:
    def __init__(self):
        ...
        self.max_nodes_per_period = 150  # Increased from 80
        self.min_edge_weight = 2
        self.max_edges_per_period = 400  # Increased from 200
        ...
        # Country code mapping for common jurisdictions
        self.country_flags = {
            'US': '🇺🇸', 'RU': '🇷🇺', 'UA': '🇺🇦', 'CN': '🇨🇳', 'GB': '🇬🇧',
            'DE': '🇩🇪', 'FR': '🇫🇷', 'IT': '🇮🇹', 'JP': '🇯🇵', 'CA': '🇨🇦',
            'BR': '🇧🇷', 'IN': '🇮🇳', 'AU': '🇦🇺', 'MX': '🇲🇽', 'ES': '🇪🇸',
    ...
    def create_sample_data(self, period):
        ...
        jurisdictions = ['RU', 'US', 'UA', 'CN', 'FR', 'Unknown']
...
<body>
    <div class="container">
        <div class="sidebar">
            <div class="header">
                ...
                <div class="subtitle">Advanced Temporal Analysis with Jurisdictions</div>
            </div>
    ...
    <script>
        ...
        function initializeNetwork() {{
            ...
            // Add click event for community analysis
            ...
            console.log('Enhanced network initialized with', allNodesData.length, 'nodes and', allEdgesData.length, 'edges');
        }}
...
Occurrences: ${{nodeData.occurrences}}
        ...
        function resetView() {{
            updateNetworkData(allNodes.get(), allEdges.get());
    ...
    def generate_jurisdiction_buttons(self, jurisdictions):
        """Generate HTML for jurisdiction filter buttons"""
        buttons = []
        for jurisdiction in jurisdictions[:12]:  # Limit to prevent overflow
    ...
    def run_enhanced_analysis(self):
        ...
        print("🚀 Starting Enhanced Network Analysis with Final Nodes Dataset")
        print("=" * 70)
        ...
        if all_nodes:
            ...
            top_jurisdictions = jurisdiction_counts.most_common(5)
        ...
        print("   ✨ Uses final_nodes.csv dataset")
        print("   📈 More nodes included (up to 150 per period)")
        print("   🌍 Jurisdiction filtering with country flags")
        print("   📅 Date-based period classification")
        print("   👥 Advanced community analysis and filtering")
        print("   📐 Node scale adjustment (0.5x - 2.5x)")
        print("   📏 Enhanced node spacing control (80-500px)")
        print("   🎨 Better visual distinction between communities")
        print("   📊 Enhanced node details with centrality metrics")
        print("   🔍 Multi-field search (entity, jurisdiction, type)")
        print("   📈 More filtering options (up to 12+ connections)")
        print("   ⚖️ Higher weight filtering (up to 20+ co-occurrences)")
        print("   🏆 Extended top nodes (30, 50, 100)")
        print("   💾 Enhanced data export with settings")
        print("   🖱️ Click nodes for detailed information")
        
        print("\n📋 USAGE GUIDE:")
        print(f"   1. Open {filename} in your browser")
        print("   2. Network loads with all periods and jurisdictions")
        print("   3. Use jurisdiction buttons to filter by country")
        print("   4. Select communities from dropdown for analysis")
        print("   5. Adjust node scale slider to change all node sizes")
        print("   6. Click individual nodes for detailed information")
        print("   7. Use enhanced filtering for deeper analysis")
        
        return filename

# Execute the enhanced analysis
if __name__ == "__main__":
    print("🌐 Enhanced Network Analyzer - Final Nodes Edition")
    print("Advanced temporal analysis with jurisdiction and community features")
    print("=" * 70)
